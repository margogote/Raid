...
/**
 * Modele de la classe �quipe sur lequel on se base pour les classements
 * 
...
public class Equipe {
	...
	// private
	/*
	 * public int compareTo(Equipe uneAutreEquipe){ int resultat=0; if
	 * (this.score.compareTo(uneAutreEquipe.score)>0) resultat = 1; if
	 * (this.score.compareTo(uneAutreEquipe.score)<=0) resultat = -1; return
	 * resultat; }
	 */
	public Equipe(int idEquipe, Date score) {
	 ...
	 * 
	 * @param scoreToAdd
	 *            , le temps correspondant au score a ajouter
	 */
	...
	/**
	 * Fonction utilisée pour pour ajouter deux dates (temps) dans la fonction
	 * addToScore(Date scoreToAdd)
	 * 
	 * @param d1
	 *            , la premiere date a ajouter
	 * @param d2
	 *            , la deuxieme date a ajouter
	 * @return
	 */
	...
	/**
	 * Fonction utilisée pour ajouter deux calendrier Fonction utilisée dans
	 * la fonction addTwoDates pour faciliter la manipulation des dates
	 * S'inscrit dans l'évolution actuelle du java
	 * 
	 * @param c1
	 *            , le calendrier a ajouter
	 * @param c2
	 *            , le calendrier a ajouter
	 * @return
	 */
	 ...
	 * 
	 * @param scoreToGet
	 *            , le score a soustraire du score actuel de l'equipe
	 */
	...
	/**
	 * Permet la soustraction de 2 dates en gérant le cas où a-b avec b>a ici
	 * dans ce cas a-b=0
	 * 
	 * @param d1
	 *            , une date
	 * @param d2
	 *            , la date a soustraire a d1
	 * @return substractTwoCal(c1, c2).getTime(), affecte de 0 si d1<d2
	 */
	 ...
	 *            , un calendrier
	 * @param c2
	 *            , le calendrier a soustraire a c1
	 * @return subCalendar, affecte de 0 si c1<c2
	 */
